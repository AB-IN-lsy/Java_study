...
public class StreamTest {
    ...
    private static void forEach() {
        ...
        APPLES.forEach(a -> System.out.println(a.getWeight())); //foreach()方法, 装的是函数
    }
    ...
    private static List<Apple> filter(Apple.Color c) {
        return APPLES.stream()
                .filter(a -> a.getColor() == c) //  a -> {return a.getColor() == c;}
                .collect(Collectors.toList()); // 进行聚合成list
    }
    ...
    private static void filter(Apple.Color c, int weight) {
        APPLES.stream()
                ...
                /**
                 * .filter(a -> a.getColor() == c && a -> a.getWeight() >= weight)
                 * */
                .collect(Collectors.toList())
                .forEach(a -> System.out.println(a.getId())); // 聚合成列表之后进行forEach方法
